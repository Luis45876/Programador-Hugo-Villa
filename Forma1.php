<html>
    ...
    <body>
      ...
      <p class="forma">Forma 1</p> <p class="tipo">(Por Salud)</p>

      <form class="contacto" method="POST" action="Forma_1_PDF.php"> 							      	
                    <p class="ocultar">&nbsp</p>
	               <h1>INGRESO DE DATOS PERSONALES</h1>
			   
		   	 <div><label >Apellido:</label> 
	           <input id="apellido" type="text" name="apellido" size="30" style="text-transform:uppercase;" required>
	             <!-- Recibe solo mayùsculas -->
	          <p class="ocultar"></p>
		      ...
		      <label >Fecha de Ingreso:</label> 
	           ...
	           <input id="fecha" type="date" name="feching" ></div>
			  <p class="ocultar"></p>
			  ...
			  <p class="ocultar"></p>
                <label >de la Escuela Nº:</label> <!-- al darle clic sobre el nombre el puntero se posiciona en get-->
	  ...
	  <input type="radio" name="transporte" id="anos" value="años" required>Años  
       ...
       <input type="radio" name="transporte" id="meses" value="meses" required>Meses
		     ...
		     <p class="ocultar"></p>
		     <label>Solicita se le :</label> <p class="ocultar"></p>
	          <input id="eleccion" type="text" name="licoinasist" readonly>	
	          <select id="justificar"  onchange="licenojust();">
			  ...
			  <br>
			   ...
			   <label>hasta el :</label> <!-- al darle clic sobre el nombre el puntero se posiciona en get-->
		        ...
		        <label>&nbsp &nbsp &nbsp &nbsp &nbsp<p class="ocultar"></p> Situación Actual: </label>
		        <p class="ocultar"></p>
	     ...
	     <select name="pruebanombre" id="causa" onchange="causafalta();"> <!-- va a la funcion causafalta dentro interactuar.js-->
			  ...
			  <br>
			  <br>
		<div>  <label>Acompañan los siguientes certìficados :</label> <!-- al darle clic sobre el nombre el puntero se posiciona en get-->
	            <input id="certific" size="50" type="text" name="certificado" >
		 	  <p class="ocultar"></p>
