...
$resultado = $conexion->query($sql);// <a href='editar_psg.php?id va a la pagina editar.php
...
if($resultado->num_rows > 0){
    ...
    while($fila = $resultado->fetch_assoc()){
        ...
        <div style='padding:10px; border:1px solid #ccc; margin:5px;'>
            ...
            <a href='editar_psg.php?id={$fila['id']}' style='text-decoration:none; color:black;'> 
